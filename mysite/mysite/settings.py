...
react and venv: https://blog.logrocket.com/creating-an-app-with-react-and-django/
...
SECRET_KEY = "django-insecure-4)69r-673chzm)j=d!x0$z#%t*pl#h$=(#gd#r$9osw7@4nmp0"
...
AUTH_USER_MODEL = (
    "home.User"  # where home is the app name and User is the model class name
)
